...
class template_admin_render
{
    ...
    public function render_page()
    {
        ...
        $this->CI->template_admin->write_view($this->__GET_REGION(),$this->___GET_VIEW_HTML(),$this->get_data());

        $this->CI->template_admin->write_view($this->__GET_REGION(),$this->__GET_VIEW_CSS(),$this->get_data());

        $this->CI->template_admin->write_view($this->__GET_REGION(),$this->__GET_VIEW_JS(),$this->get_data());
    ...
    public function title($title = null){
        ...
        $this->CI->template_admin->write('name',$title);
    }

    public function render(){

        $this->CI->template_admin->render();
    }
