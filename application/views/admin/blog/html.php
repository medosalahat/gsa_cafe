<div id="page-wrapper" style="min-height: 164px;">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div id="toolbar2">
                <button class="btn btn-warning btn-xs" id="add_blog_btn">Add Blog</button>
            </div>
            <table id="table" data-toggle="table"
                   data-url="<?= site_url('admin/home/get_blog') ?>"
                ...
                <tr>
                    ...
                    <th data-field="<?= $tbl->get_status() ?>"
                        data-align="center"
                        data-formatter="<?= $tbl->get_status() ?>_change"
...
<div class="modal fade" id="add_row" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= site_url('admin/home/add_blog_info') ?>" method="post" id="form_add_blog">
...
<div class="modal fade" id="edit_row" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= site_url('admin/home/update_blog_info') ?>" method="post" id="form_edit_blog">
